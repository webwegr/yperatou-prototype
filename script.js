  ...
  app.innerHTML = h() + `
    ...
    <section class="mt-5 rounded-[2rem] border border-slate-800 bg-slate-900/60 p-5">
      ...
      <p class="mt-2 text-sm text-slate-400">
        Διάλεξε attribute. Μεγαλύτερο κερδίζει, εκτός από το 0-100 όπου κερδίζει η μικρότερη τιμή.
...
function game() {
  app.innerHTML = h() + `
    ...
    <p class="mb-3 text-sm font-bold text-slate-400">Διάλεξε attribute για την κάρτα σου.</p>
...
function result() {
  ...
  app.innerHTML = h() + `
    <section class="mb-4 rounded-3xl border border-amber-400/30 bg-slate-900 p-4 text-center">
      <p class="text-sm text-slate-400">Selected: <b>${r.a.label}</b></p>
